...
function Configuracoes() {
  ...
  const duvidasFrequentes = [
    { pergunta: "Como agendar uma consulta?", resposta: "Para agendar uma consulta, acesse a página de Serviços para escolher o procedimento e clique em 'Agendar Consulta', escolha o dentista e selecione a data e horário disponíveis." },
